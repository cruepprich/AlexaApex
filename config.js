...
config.web = {}
config.web.http = {};
config.web.http.port = process.env.PORT || '8080';
...
config.web.https.port = process.env.PORT || '4443';
config.web.https.keyPath = './private-key.pem';
config.web.https.certPath = './cert.cer';
...
config.ords.webContainerUrl = process.env.WEB_CONTAINER_URL || 'http://bmcapex:8080'; // This is the link to tomcat or glassfish server
...
config.apex.images.directory = process.env.APEX_IMAGES_DIR || '../../apex511/apex/images';

config.apex.custom = {};
config.apex.custom.path = '/c';
config.apex.custom.directory = process.env.APEX_IMAGES_DIR || './custom'
